...
```{r}
data <- read_csv("Melbourne dwelling data.csv") 
...
## Get the data
There is a codebook available here which explains the meaning of every variable. 
